                ...
                <div>
                  ...
                  <div className='relative flex inline'>
                    ...
                    <h3 className=' text-left'>
                      Browse our curated boxes of products from Irish artisans
                      and producers, and choose the trial, 3 month, 6 month or
                      12 month subscription plan that suits you best.
                    </h3>
                  </div>
                </div>
                <div>
          ...
          >
            <div className='flex'>
              ...
              <div className='center-review'>
                ...
                <h2>NJ, USA</h2>
                <h3>
                  &apos;My grandmother peggy left Ireland to New York in her
                  20s, she came from Arvagh in Cavan. We ordered irish
                  impressions to surprise her with a taste of home each month.
                  She couldn&apos;t be more happy with the handmade crafts and
                  always has a smile on her face when her new box arrives. She
                  especially loves hearing the &apos;yarns&apos; or poems
                  included in every box. Thank you Irish Impressions&apos;
                </h3>
              </div>
            ...
            <div className='flex'>
              ...
              <div className='center-review'>
                ...
                <h3>
                  ...
                  selection of products truly captured the essence of Ireland
                  and made me feel connected to the culture. Highly recommend to
            ...
            <div className='flex'>
              ...
              <div className='center-review'>
                ...
                <h3>
                  &apos;Irish Impressions subscription box is the best yet! I
                  love getting it every month, it&apos;s full of amazing crafts
                  that you won&apos;t get anywhere else. It&apos;s like a little
                  piece of Ireland delivered through my door. I totally
                  recommend it to anyone who wants to discover unique Irish
                  crafts and food while supporting true Irish talent.&apos;
                </h3>
              </div>
              <div className='right-review'>
                <img
